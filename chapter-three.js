...
window.createThirdNight = function createThirdNight(api) {
 ...
 function witness(id){
  ...
  if(id==='keeper')speak('역무원 · 여울',[
   ...
   "“당신이 부탁했어요. 오늘 마지막 것까지 돌려주면\n같이 나가자고. 제가 알겠다고 했죠.”",
   "“그런데 막상 방울을 돌려받으니 무서웠어요.\n나루는 왜 안 왔는지, 밖에 나가면 알게 될 테니까.”",
   "“그래서 방울을 다시 뒀어요. 당신 이름도 돌려주지 않았고.”\n그녀가 서랍의 열쇠를 당신에게 건넸다.",
   "“기다린다는 말로 속인 건 동생만이 아니었네요.”"
  ],()=>remember(id));
   ...
   "“그 뒤에 이름을 맡기셨죠.\n이름을 부르면 또 찾으러 가게 된다고.”",
   "“저도 재발급만 했습니다. 안내 문구 뒤에 숨었죠.”\n03호는 취소표를 이번엔 버리지 않았다."
 ],()=>remember(id));
  else speak('고양이 · 후추',[
   `${address()}. 어제 네가 여기 나갈 때 같이 가자고 했어.`,
   "“나는 못 간다고 했어.\n이 역에 맡긴 기억인데 밖에 나가면 어떻게 되겠어.”",
   "“진짜 못 가는지 물어본 적은 없어.\n네가 그럼 안 간다고 할 줄 알았지.”",
   "후추가 발톱으로 바닥을 긁었다.\n“그 말 하고 네 표가 취소되는 소리를 들었어.”",
   "“신호실에 백지라는 사람이 있어.\n이번에는 그 사람한테 직접 물어보자.”"
  ],()=>remember(id));
 }
 function inspector(){
  ...
  speak('이름 없는 검표원',[
   "“폐역을 신청하신 분이군요. 백지입니다.”\n검표원은 당신의 표보다 후추를 먼저 봤다.",
   "“고양이부터 말씀드리죠. 못 나가는 게 아닙니다.\n지금은 모든 선로가 같은 곳으로 돌아오도록 돼 있어요.”",
   "서류에는 어린 글씨로 적혀 있었다.\n「혼자 기다리는 사람이 다 갈 때까지 열차를 보내지 말 것.」",
   "아버지를 기다리던 당신의 글씨였다.\n바로 아래, 어제의 당신이 「폐역 요청」이라고 썼다.",
   "“새 손님은 계속 옵니다. 이 규정으로는 못 떠나죠.\n그래서 역 자체를 닫으려 하셨습니다.”",
   "“하지만 선로를 나누면 됩니다. 남길 기억, 기다릴 자리,\n떠날 길. 꼭 역을 없애야 하는 건 아닙니다.”"
 ],null,[
 ...
 function explain(question){speak('검표원 · 백지',[
  question==='leave'?'“없어지지 않습니다. 후추도 기억을 가지고 탈 수 있어요.”\n후추가 작게 물었다. “그럼 창가 자리도?”':'“대기선을 남기면 됩니다. 누가 기다리는 동안에도\n출발선의 열차는 떠날 수 있도록요.”',
   "“어제는 보관선, 아직은 대기선, 이제는 출발선.\n위쪽 세 신호를 바꾸고 가운데 제어대에서 확인해주세요.”",
   "“왜 어제는 이 방법을 말 안 했어요?”\n백지의 손이 멈췄다. “신청받은 일만 처리했습니다.”",
