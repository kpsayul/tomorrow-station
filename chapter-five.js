...
window.createFifthStory=function(api){
 ...
 function keeper(){
  ...
  if(!p().met){speak('검표원 · 백지',[
   ...
   "이야기: 당신이 반송된 봉투를 책상에 놓았다.\n당신: 나루의 편지도 이렇게 돌려보냈나요?",
   "백지: 네. ‘내일 받겠다’를 ‘오늘은 거절’로 처리했어요. 열두 번.\n또 보내실 거라고 생각했습니다.\n이야기: 백지가 도장을 내려놓았다.",
   "당신: 손님에게는 제가 다시 물어봐도 될까요?\n이야기: 백지가 잠시 망설이다 접수표를 당신에게 건넸다."
 ],()=>{p().met=true;});return;}
  ...
  speak('검표원 · 백지',[
   '백지: 물결마을, 18:05. 저녁에 늦지 않겠군요.\n이야기: 백지는 자기 표를 처음부터 끝까지 읽었다.',
 ...
 function visitor(){
  ...
  speak('물 한 잔',[
   ...
   p().guestChoice==='quiet'?'손님: 오늘은 이름 안 맡길래요.\n이야기: 손님이 빈 서명란을 직접 접었다.\n손님: 내일은 모르겠고요.':'당신: 그래서 뭐라고 답했어요?\n손님: 아직요.\n이야기: 손님이 화면을 껐다.\n손님: 내가 잊을 일은 아닌 것 같아서.',
   '이야기: 백지가 접수표를 가지러 왔다.\n손님: 그건 제가 갖고 있을게요.\n이야기: 그는 빈손으로 돌아갔다.',
 ...
 function depart(){speak('먼저 떠나는 검표원',[
   "백지가 마지막 서류를 내밀었다.\n「폐역 신청 취소 / 신청인 확인」",
   "이야기: 당신은 이름 칸 대신 변경 사유에 적었다.\n당신의 기록: 남은 사람이 있어도, 떠나는 열차는 보낼 것.",
   "백지: 누가 도장을 찍죠?\n03호: 신청받은 것만 처리하신다면서요. 처리해주세요.\n이야기: 백지가 작게 웃고 도장을 찍었다.",
  state().choice==='hang'?'문 위의 방울이 울렸다.\n이번에는 주인이 사라졌다고 신고하는 사람이 없었다.':'후추가 백지에게 여울의 안부를 전했다.\n“방울 든 사람이 바닷가에 있어. 직접 만나서 물어봐.”',
   "백지: 내일은…\n당신: 돌아오는 날짜는 정하면 알려주세요.\n이야기: 백지는 빈 귀환란을 그대로 접었다.",
   "이야기: 기차가 떠났다. 당신은 어린 자신의 편지를 펼쳤다.\n어린 온의 편지: 바다 가면 꼭 적어줘. 후추 말고 네 얘기도.",
   "당신의 답장: 오늘 바다 봤어. 후추도 같이 갔어. 늦어서 미안.\n이야기: 거기까지 쓰고 종이를 접으려는데, 후추가 앞발로 눌렀다.",
   "후추: 네 얘기는?\n이야기: 당신은 펜을 다시 들었다.\n당신의 답장: 나는 오늘 재미있었어. 다음에도 가고 싶어.",
